...
#define ARROW_CXX_COMPILER_VERSION "12.4.0"
#define ARROW_CXX_COMPILER_FLAGS " -Wno-noexcept-type -fvisibility-inlines-hidden -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/open_source_contribution/venv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/apache-arrow_1723204191882/work=/usr/local/src/conda/apache-arrow-17.0.0 -fdebug-prefix-map=/workspaces/open_source_contribution/venv=/usr/local/src/conda-prefix -fdiagnostics-color=always -fuse-ld=gold  -Wall -fno-semantic-interposition -fvisibility-inlines-hidden -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/open_source_contribution/venv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/apache-arrow_1723204191882/work=/usr/local/src/conda/apache-arrow-17.0.0 -fdebug-prefix-map=/workspaces/open_source_contribution/venv=/usr/local/src/conda-prefix"
