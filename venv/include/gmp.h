...
#define __GMP_CFLAGS "-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/open_source_contribution/venv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/gmp_1718980463540/work=/usr/local/src/conda/gmp-6.3.0 -fdebug-prefix-map=/workspaces/open_source_contribution/venv=/usr/local/src/conda-prefix"
