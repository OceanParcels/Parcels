...
NumbaFieldCZG = jitclass(NumbaField, spec=_base_field_spec() + [("grid", as_numba_type(CurvilinearZGrid))])
NumbaFieldCSG = jitclass(NumbaField, spec=_base_field_spec() + [("grid", as_numba_type(CurvilinearSGrid))])
NumbaFieldRZG = jitclass(NumbaField, spec=_base_field_spec() + [("grid", as_numba_type(RectilinearZGrid))])
NumbaFieldRSG = jitclass(NumbaField, spec=_base_field_spec() + [("grid", as_numba_type(RectilinearSGrid))])
