...
def check_corrupted_files(filelist, fieldname, outputfile=None):
    """
    parameter filelist: list of files which contain the field with name 'fieldname'
    parameter fieldname: name of the field that is checked
    parameter outputfile: list of corrupted files is written into a output text file
    """
