...
class FieldSet:
    ...
    def from_data(cls, data, dimensions, transpose=False, mesh='spherical',
        ...
        mesh : str
            ...
            units used during velocity interpolation, see also `this tutorial <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_unitconverters.ipynb>`__:
        ...
        * `Analytical advection <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_analyticaladvection.ipynb>`__

        * `Diffusion <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_diffusion.ipynb>`__

        * `Interpolation <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_interpolation.ipynb>`__
    ...
    def add_field(self, field, name=None):
        ...
        * `Unit converters <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_unitconverters.ipynb>`__ (Default value = None)
    ...
    def from_netcdf(cls, filenames, variables, dimensions, indices=None, fieldtype=None,
        ...
        mesh : str
            String indicating the type of mesh coordinates and
            units used during velocity interpolation, see also `this tuturial <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_unitconverters.ipynb>`__:
        ...
        * `Basic Parcels setup <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/parcels_tutorial.ipynb>`__

        * `Argo floats <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_Argofloats.ipynb>`__

        * `Timestamps <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_timestamps.ipynb>`__

        * `Time-evolving depth dimensions <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_timevaryingdepthdimensions.ipynb>`__
    ...
    def from_nemo(cls, filenames, variables, dimensions, indices=None, mesh='spherical',
        ...
        See `here <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_nemo_curvilinear.ipynb>`__
        for a detailed tutorial on the setup for 2D NEMO fields and `here <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_nemo_3D.ipynb>`__
        for the tutorial on the setup for 3D NEMO fields.

        See `here <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/documentation_indexing.ipynb>`__
        ...
        **kwargs :
        ...
        if 'U' in dimensions and 'V' in dimensions and dimensions['U'] != dimensions['V']:
            raise ValueError("On a C-grid, the dimensions of velocities should be the corners (f-points) of the cells, so the same for U and V. "
                             "See also https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/documentation_indexing.ipynb")
    ...
    def from_mom5(cls, filenames, variables, dimensions, indices=None, mesh='spherical',
        ...
        mesh : str
            String indicating the type of mesh coordinates and
            units used during velocity interpolation, see also the `Unit converters tutorial <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_unitconverters.ipynb>`__:
    ...
    def add_constant(self, name, value):
        ...
        `Analytical advection <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_analyticaladvection.ipynb>`__
        `Diffusion <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_diffusion.ipynb>`__
        `Periodic boundaries <https://nbviewer.jupyter.org/github/OceanParcels/parcels/blob/master/docs/examples/tutorial_periodic_boundaries.ipynb>`__
        """
