...
class FieldSet(object):
    ...
    def from_data(cls, data, dimensions, transpose=False, mesh='spherical',
        ...
        :param time_periodic: To loop periodically over the time component of the Field. It is set to either False or the length of the period (either float in seconds or datetime.time_delta object). (Default: False)
