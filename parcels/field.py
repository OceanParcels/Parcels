...
class Field(object):
    ...
    :param time_periodic: To loop periodically over the time component of the Field. It is set to either :param False or the total timespan that is to be covered by the periodically-repeating field, given either as :type float (in seconds) or :type datetime.timedelta object).
