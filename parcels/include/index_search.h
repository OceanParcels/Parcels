...
static inline ErrorCode search_indices_vertical_z(double z, int zdim, float *zvals, int *zi, double *zeta)
{
...
static inline ErrorCode search_indices_vertical_s(double z, int xdim, int ydim, int zdim, float *zvals,
...
static inline ErrorCode search_indices_rectilinear(double x, double y, double z, CStructuredGrid *grid, GridCode gcode,
                                                   int *xi, int *yi, int *zi, double *xsi, double *eta, double *zeta,
...
static inline ErrorCode search_indices_curvilinear(double x, double y, double z, CStructuredGrid *grid, GridCode gcode,
                                                   int *xi, int *yi, int *zi, double *xsi, double *eta, double *zeta,
                                                   int ti, double time, double t0, double t1)
{
  int xi_old = *xi;
 ...
 * */
static inline ErrorCode search_indices(double x, double y, double z, CStructuredGrid *grid,
                                       int *xi, int *yi, int *zi, double *xsi, double *eta, double *zeta,
