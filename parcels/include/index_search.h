...
typedef enum
  {
    SUCCESS=0, EVALUATE=1, REPEAT=2, DELETE=3, ERROR=4, ERROR_INTERPOLATION=41, ERROR_OUT_OF_BOUNDS=5, ERROR_THROUGH_SURFACE=51, ERROR_TIME_EXTRAPOLATION=6, STOP_EXECUTION=7
  } ErrorCode;
