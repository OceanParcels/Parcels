...
typedef enum
  {
    SUCCESS=0, EVALUATE=1, REPEAT=2, DELETE=3, STOP_EXECUTION=4, ERROR=5, ERROR_INTERPOLATION=51, ERROR_INTERPOLATION_X=52, ERROR_INTERPOLATION_Y=53, ERROR_INTERPOLATION_Z=54, ERROR_OUT_OF_BOUNDS=6, ERROR_THROUGH_SURFACE=61, ERROR_TIME_EXTRAPOLATION=7
  } StatusCode;
