...
.. toctree::
   :maxdepth: 1
   :titlesonly:
   :caption: Tutorials on setting up FieldSets
...
.. toctree::
   :maxdepth: 1
   :titlesonly:
   :caption: Tutorials on creating ParticleSets
...
.. toctree::
   :maxdepth: 1
   :titlesonly:
   :caption: Tutorials on writing kernels to be executed on each particle
