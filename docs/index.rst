...
2. Download Parcels' `environment_win32.yml <https://raw.githubusercontent.com/OceanParcels/parcels/master/environment_win32.yml>`_ file from the main Parcels' directory, start the ``Anaconda Prompt`` and run::
