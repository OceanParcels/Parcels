...
actions = [
    ...
    Action("Field",           "interpolator2D()",                "make_private"  , skip_reason = "Removed implementation"),
    Action("Field",           "interpolator3D()",                "make_private"  , skip_reason = "Removed implementation"),
    Action("Field",           "spatial_interpolation()",         "make_private"  ),
    Action("Field",           "time_index()",                    "make_private"  , skip_reason = "Removed implementation"),
