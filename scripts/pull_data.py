...
moving_eddies_example = {'url': "http://oceanparcels.org/examples-data/MovingEddies_data",
                         'filenames': ["moving_eddiesP.nc", "moving_eddiesU.nc", "moving_eddiesV.nc"],
                         'path': "examples/MovingEddies_data"}

OFAM_example = {'url': "http://oceanparcels.org/examples-data/OFAM_example_data",
...
globcurrent_example = {'url': "http://oceanparcels.org/examples-data/GlobCurrent_example_data",
                       'filenames': globfiles,
...
if __name__ == "__main__":
    pulldata(**moving_eddies_example).download()
    pulldata(**OFAM_example).download()
    pulldata(**globcurrent_example).download()
